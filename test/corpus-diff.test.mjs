...
test("reports additions, removals, content changes, and status transitions", async (t) => {
  ...
  assert.deepEqual(report.summary, { added: 1, removed: 1, changed: 1, statusTransitions: 1 });
...
test("can limit a shadow comparison to selected title IDs", async (t) => {
  ...
  assert.deepEqual(report.summary, { added: 0, removed: 0, changed: 0, statusTransitions: 0 });
